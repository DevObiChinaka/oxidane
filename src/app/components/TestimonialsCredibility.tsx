...
const testimonials = [
  {
    ...
    location: "Singapore",
    image: (
      <div className="w-20 h-20 mx-auto rounded-full bg-gradient-to-br from-purple-100 to-blue-100 flex items-center justify-center overflow-hidden ring-4 ring-purple-100 shadow-lg">
        <img 
  ...
  return (
    <section className="py-20 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {realResults.map((result, index) => (
              <div key={index} className="bg-gradient-to-br from-purple-50 to-blue-50 rounded-xl p-6 text-center">
                <div className="text-3xl font-bold text-gradient-purple mb-2">{result.value}</div>
        ...
        <div className="bg-gradient-to-br from-gray-50 to-purple-50 rounded-3xl p-8 md:p-12 mb-16">
            ...
            <div className="mt-8 bg-slate-800/50 backdrop-blur-sm rounded-xl p-6 border border-slate-700/50">
              ...
              <div className="flex justify-center items-center space-x-8">
                {testimonials.map((testimonial, index) => (
                  ...
                  >
                    <div className={`w-16 h-16 mx-auto rounded-full bg-gradient-to-br from-purple-100 to-blue-100 flex items-center justify-center overflow-hidden transition-all duration-300 ${
                      index === currentTestimonial 
                        ? 'ring-4 ring-purple-400 shadow-lg shadow-purple-500/30' 
                        : 'ring-2 ring-gray-400 group-hover:ring-purple-300'
                    }`}>
                      <img 
                    ...
                    <div className="mt-2 text-center">
                      <p className={`text-xs font-medium transition-colors duration-300 ${
                        index === currentTestimonial ? 'text-purple-300' : 'text-gray-400'
                      }`}>
                        {testimonial.name}
                      </p>
                      <p className={`text-xs transition-colors duration-300 ${
                        index === currentTestimonial ? 'text-purple-400' : 'text-gray-500'
                      }`}>
                        {testimonial.result}
                      </p>
                    </div>
