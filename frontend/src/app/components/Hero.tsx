          ...
          <div className="space-y-6 w-full max-w-full overflow-hidden">
            ...
            <div className="bg-white/8 backdrop-blur-2xl border border-white/15 rounded-2xl p-4 sm:p-5 md:p-6 shadow-2xl">
              ...
              <div className="space-y-4">
                {/* Pair List - Horizontal on all screens */}
                ...
                {/* Selected Pair Widget - Full Width */}
                <div className="w-full">
                  <div className="relative bg-gradient-to-br from-white/10 to-white/5 rounded-2xl overflow-hidden border-2 border-white/20 shadow-2xl">
                    {/* Chart Header - Moved to bottom right to avoid TradingView's built-in label */}
                    <div className="absolute bottom-4 right-4 bg-black/60 backdrop-blur-md px-3 py-2 rounded-lg border border-white/20 z-10 shadow-lg">
                    ...
                    <iframe 
                      key={selectedPair}
                      src={`https://www.tradingview-widget.com/embed-widget/mini-symbol-overview/?locale=en#%7B%22symbol%22%3A%22FX:${selectedPair}%22%2C%22width%22%3A%22100%25%22%2C%22height%22%3A%22380%22%2C%22dateRange%22%3A%221D%22%2C%22colorTheme%22%3A%22dark%22%2C%22trendLineColor%22%3A%22rgba(0%2C%20179%2C%20143%2C%201)%22%2C%22underLineColor%22%3A%22rgba(0%2C%20179%2C%20159%2C%200.3)%22%2C%22isTransparent%22%3Atrue%2C%22autosize%22%3Afalse%2C%22largeChartUrl%22%3A%22%22%7D`}
                      className="w-full h-[280px] sm:h-[320px] lg:h-[380px] border-0"
