...
const services = [
  ...
  },
  {
    ...
    description: 'Live interaction with traders and mentors in our active Telegram community.',
    features: [
      'Live trading sessions & analysis',
      'Direct Q&A with instructors',
      'Telegram signals group access',
  ...
  },
  {
    ...
    description: 'Structured video courses covering strategies, technical analysis, and risk management.',
    features: [
      'HD video lessons on demand',
      'SMC, ALGO, & advanced strategies',
    ...
    <section id="services" className="py-16 md:py-24 bg-gray-50 overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12 md:mb-16">
          <div className="inline-flex items-center px-4 py-2 bg-[#00B38F] text-white rounded-full text-xs md:text-sm font-medium mb-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
          {services.map((service, index) => (
            <div 
              key={index}
              className="relative bg-white rounded-lg shadow-lg p-6 md:p-8 hover:shadow-xl transition-shadow duration-300 border border-gray-200"
            >
              {/* Icon Container */}
              <div className="flex justify-center mb-4 md:mb-6">
                <div className="w-14 h-14 md:w-16 md:h-16 bg-gray-50 rounded-lg flex items-center justify-center">
                  {service.icon}
                </div>
              </div>
                ...
                <ul className="space-y-2 md:space-y-3">
                  {service.features.map((item, featureIndex) => (
                    <li key={featureIndex} className="flex items-start space-x-2 md:space-x-3">
                      <div className="w-4 h-4 md:w-5 md:h-5 bg-[#00B38F] rounded flex items-center justify-center flex-shrink-0 mt-0.5">
        ...
        <div className="text-center mt-16 md:mt-20">
          <div className="bg-white rounded-lg shadow-lg p-6 md:p-8 max-w-4xl mx-auto">
            <div className="text-2xl sm:text-3xl font-bold text-gray-900 mb-4 md:mb-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 md:gap-8 mb-6 md:mb-8">
              <div className="text-center">
                <div className="flex justify-center mb-2 md:mb-3">
                  <svg className="w-6 h-6 md:w-8 md:h-8 text-[#00B39F]" fill="none" stroke="currentColor" strokeWidth={1.5} viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" d="M3 13.125C3 12.504 3.504 12 4.125 12h2.25c.621 0 1.125.504 1.125 1.125v6.75C7.5 20.496 6.996 21 6.375 21h-2.25A1.125 1.125 0 013 19.875v-6.75zM9.75 8.625c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125v11.25c0 .621-.504 1.125-1.125 1.125h-2.25a1.125 1.125 0 01-1.125-1.125V8.625zM16.5 4.125c0-.621.504-1.125 1.125-1.125h2.25C20.496 3 21 3.504 21 4.125v15.75c0 .621-.504 1.125-1.125 1.125h-2.25a1.125 1.125 0 01-1.125-1.125V4.125z" />
                  </svg>
                </div>
                <div className="font-semibold text-gray-900 mb-1 md:mb-2 text-sm md:text-base">Premium Signals</div>
                <div className="text-xs md:text-sm text-gray-600">High-probability setups daily</div>
              </div>
              <div className="text-center">
                <div className="flex justify-center mb-2 md:mb-3">
                  <svg className="w-6 h-6 md:w-8 md:h-8 text-[#000ABE]" fill="none" stroke="currentColor" strokeWidth={1.5} viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" d="M15 19.128a9.38 9.38 0 002.625.372 9.337 9.337 0 004.121-.952 4.125 4.125 0 00-7.533-2.493M15 19.128v-.003c0-1.113-.285-2.16-.786-3.07M15 19.128v.106A12.318 12.318 0 018.624 21c-2.331 0-4.512-.645-6.374-1.766l-.001-.109a6.375 6.375 0 0111.964-3.07M12 6.375a3.375 3.375 0 11-6.75 0 3.375 3.375 0 016.75 0zm8.25 2.25a2.625 2.625 0 11-5.25 0 2.625 2.625 0 015.25 0z" />
                  </svg>
                </div>
                <div className="font-semibold text-gray-900 mb-1 md:mb-2 text-sm md:text-base">Expert Community</div>
                <div className="text-xs md:text-sm text-gray-600">Learn from professional traders</div>
              </div>
              <div className="text-center">
                <div className="flex justify-center mb-2 md:mb-3">
                  <svg className="w-6 h-6 md:w-8 md:h-8 text-[#00B38F]" fill="none" stroke="currentColor" strokeWidth={1.5} viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" d="M12 6.042A8.967 8.967 0 006 3.75c-1.052 0-2.062.18-3 .512v14.25A8.987 8.987 0 016 18c2.305 0 4.408.867 6 2.292m0-14.25a8.966 8.966 0 016-2.292c1.052 0 2.062.18 3 .512v14.25A8.987 8.987 0 0118 18a8.967 8.967 0 00-6 2.292m0-14.25v14.25" />
                  </svg>
                </div>
                <div className="font-semibold text-gray-900 mb-1 md:mb-2 text-sm md:text-base">Comprehensive Education</div>
                <div className="text-xs md:text-sm text-gray-600">Complete trading curriculum</div>
              </div>
            </div>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link 
                href="/pricing" 
                className="bg-[#00B38F] text-white px-6 sm:px-8 py-3 sm:py-4 rounded-lg font-semibold hover:bg-[#00A87D] transition-colors text-base md:text-lg"
              >
                View Pricing Plans
              </Link>
            </div>
