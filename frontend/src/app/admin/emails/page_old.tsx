...
export default function EmailTemplatesPage() {
  ...
  const getTemplateTypeIcon = (templateType: string) => {
    // Return Heroicon SVG for each template type
    ...
    switch (templateType) {
      ...
      case 'newsletter':
        return <svg className={iconClass} fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 20H5a2 2 0 01-2-2V6a2 2 0 012-2h10a2 2 0 012 2v1m2 13a2 2 0 01-2-2V7m2 13a2 2 0 002-2V9a2 2 0 00-2-2h-2m-4-3H9M7 16h6M7 8h6v4H7V8z" /></svg>;
      case 'reminder':
          ...
          <div className="bg-white overflow-hidden shadow-sm border border-gray-200 rounded-lg">
            ...
            <div className="bg-gray-50 px-5 py-3 border-t border-gray-100">
              <div className="text-sm">
                <span className="font-medium text-gray-900">{analytics.recent_sent}</span>
          ...
          <div className="bg-white rounded-lg shadow-xl max-w-md w-full p-6">
            ...
            {notification.details && (
              <div className="bg-gray-50 border border-gray-200 rounded-lg p-4 mb-4">
                <h4 className="font-medium text-gray-900 mb-2">Campaign Results</h4>
                <div className="grid grid-cols-3 gap-2 text-sm">
                  <div className="text-center">
                    <div className="text-2xl font-bold text-gray-900">{notification.details.sent}</div>
                    <div className="text-gray-600">Sent</div>
                  </div>
                  <div className="text-center">
                    <div className="text-2xl font-bold text-gray-900">{notification.details.failed}</div>
                    <div className="text-gray-600">Failed</div>
                  </div>
                  <div className="text-center">
                    <div className="text-2xl font-bold text-gray-900">{notification.details.total}</div>
            ...
            <button
              ...
              className="w-full py-3 px-4 rounded-lg font-medium transition-colors bg-gray-900 hover:bg-gray-800 text-white"
            >
              OK
            </button>
          </div>
