                ...
                <div className="p-5">
                  <div className="flex items-center">
                    ...
                    <div className="ml-5 w-0 flex-1">
                      <dl>
                        <dt className="text-sm font-medium text-gray-600 truncate">Total Templates</dt>
                        <dd className="text-lg font-semibold text-gray-900">{analytics.total_templates}</dd>
                      </dl>
                    </div>
                  </div>
                </div>
              ...
              <div className="bg-gray-50 overflow-hidden shadow rounded-lg border border-gray-200">
                <div className="p-5">
                  <div className="flex items-center">
                    ...
                    <div className="ml-5 w-0 flex-1">
                      <dl>
                        <dt className="text-sm font-medium text-gray-600 truncate">Emails Sent</dt>
                        <dd className="text-lg font-semibold text-gray-900">{analytics.total_sent}</dd>
                      </dl>
                    </div>
                  </div>
                </div>
              ...
              <div className="bg-gray-50 overflow-hidden shadow rounded-lg border border-gray-200">
                <div className="p-5">
                  <div className="flex items-center">
                    ...
                    <div className="ml-5 w-0 flex-1">
                      <dl>
                        <dt className="text-sm font-medium text-gray-600 truncate">Success Rate</dt>
                        <dd className="text-lg font-semibold text-gray-900">{analytics.success_rate}%</dd>
                      </dl>
                    </div>
                  </div>
                </div>
              ...
              <div className="bg-gray-50 overflow-hidden shadow rounded-lg border border-gray-200">
                <div className="p-5">
                  <div className="flex items-center">
                    ...
                    <div className="ml-5 w-0 flex-1">
                      <dl>
                        <dt className="text-sm font-medium text-gray-600 truncate">Recent (30d)</dt>
                        <dd className="text-lg font-semibold text-gray-900">{analytics.recent_sent}</dd>
                      </dl>
                    </div>
                  </div>
                </div>
                          ...
                          <div className="flex items-start space-x-4 flex-1">
                            ...
                            <div className="flex-1 min-w-0">
                              ...
                              <div className="mt-2 flex items-center space-x-4 text-xs text-gray-500">
                                <span>Subject: {template.subject_template}</span>
                                <span>•</span>
                      ...
                      <tbody className="bg-white divide-y divide-gray-200">
                        {emailLogs.map((log) => (
                          <tr key={log.id} className="hover:bg-gray-50">
                            ...
                            <td className="px-4 py-4 whitespace-nowrap">
                              <div className="text-sm text-gray-900">{log.template_name}</div>
                              <div className="text-xs text-gray-500">{log.template_type}</div>
                            </td>
